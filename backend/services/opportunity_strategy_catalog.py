...
SYSTEM_OPPORTUNITY_STRATEGY_SEEDS: list[SystemOpportunityStrategySeed] = [
    ...
    SystemOpportunityStrategySeed(
        slug="weather_coldmath_carry",
        source_key="weather",
        import_module="services.strategies.weather_coldmath_carry",
        sort_order=203,
        config_schema={
            "param_fields": [
                {"key": "carry_enabled", "label": "Carry Mode Enabled", "type": "boolean"},
                {
                    "key": "carry_max_yes_price",
                    "label": "Carry Max YES Price",
                    "type": "number",
                    "min": 0.01,
                    "max": 0.10,
                },
                {
                    "key": "carry_min_no_edge_percent",
                    "label": "Carry Min NO Edge (%)",
                    "type": "number",
                    "min": 0,
                    "max": 10,
                },
                {
                    "key": "carry_base_size_usd",
                    "label": "Carry Base Size (USD)",
                    "type": "number",
                    "min": 10,
                    "max": 5000,
                },
                {
                    "key": "carry_max_size_usd",
                    "label": "Carry Max Size (USD)",
                    "type": "number",
                    "min": 10,
                    "max": 10000,
                },
                {"key": "lottery_enabled", "label": "Lottery Mode Enabled", "type": "boolean"},
                {
                    "key": "lottery_max_yes_price",
                    "label": "Lottery Max YES Price",
                    "type": "number",
                    "min": 0.001,
                    "max": 0.10,
                },
                {
                    "key": "lottery_min_yes_edge_percent",
                    "label": "Lottery Min YES Edge (%)",
                    "type": "number",
                    "min": 0,
                    "max": 50,
                },
                {
                    "key": "lottery_base_size_usd",
                    "label": "Lottery Base Size (USD)",
                    "type": "number",
                    "min": 1,
                    "max": 500,
                },
                {
                    "key": "lottery_max_size_usd",
                    "label": "Lottery Max Size (USD)",
                    "type": "number",
                    "min": 1,
                    "max": 1000,
                },
                {"key": "sigma_c", "label": "Sigma (C)", "type": "number", "min": 0.5, "max": 5.0},
                {
                    "key": "max_hours_to_resolution",
                    "label": "Max Hours to Resolution",
                    "type": "number",
                    "min": 1,
                    "max": 168,
                },
                {"key": "max_buckets_per_event", "label": "Max Buckets per Event", "type": "integer", "min": 1, "max": 10},
                {"key": "carry_risk_base_score", "label": "Carry Base Risk Score", "type": "number", "min": 0, "max": 1},
                {"key": "lottery_risk_base_score", "label": "Lottery Base Risk Score", "type": "number", "min": 0, "max": 1},
            ]
        },
    ),
